...
const EventCard = () => {
    const event =  {
        ...
        description: "Explore the world of art and creativity with exhibitions, workshops, and live performances.",
        ...
        category: "art",
        banner: "https://img.freepik.com/free-psd/neon-horizontal-banner-template-electronic-music-with-female-dj_23-2148979684.jpg?t=st=1746213045~exp=1746216645~hmac=643d6ab7ff0eadae44ff0a70758d21b057c5a605057347ed134d673c72c3a996&w=1380",
        status: "upcoming",
        createdAt: new Date(),
        updatedAt: new Date()
      };
