...
const Features = () => {
  const featuresList = [
    ...
    },
    {
      ...
      description: 'Hear from industry leaders about the latest trends and innovations.'
    },
    {
      icon: '🚀',
      title: 'Exhibition of Technologies',
      description: 'Explore cutting-edge technologies and solutions from exhibitors.'
    },
    {
      icon: '📱',
      title: 'Mobile Ready',
    ...
    },
    {
      ...
      description: 'Participate in interactive workshops to enhance your skills.'
    },
    {
      icon: '🤝',
